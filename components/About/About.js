...
export default function About() {
  return (
    <div
      ...
      className={[
        styles.about +
          " w-1/2 rounded-3xl pl-7 pr-3 py-4 text-white text-left z-10",
      ]}
    >
      ...
      <p className={[styles.about + " font-semibold my-4"]}>
        + Multi-disciplinary designer interested in creative coding:
        interactive, animated, and beautifully curated web experiences.
      </p>
      <p className={styles.about}>
