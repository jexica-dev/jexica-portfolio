        ...
        <div className="">
          <div className="pl-7  text-black text-left py-10 px-30 mx-5  mb-7  flex justify-around rounded-3xl bg-right-top bg-gradient01 animate-movebg w-96 h-60 bg-cover filter">
            <p className="name-logo  text-6xl font-whyteinktrap">
              Creative Developer
              <div className="flex flex-row hover:animate-bounce pt-3 pr-3 justify-end">
                <div className=" text-3xl pr-5 pt-3 animate-wiggle">
                  {arrow}
                </div>
                <p className="  z-50 hover:animate-bounce hover:text-red flex justify-around text-white rounded-full py-3 px-10 whitespace-nowrap font-bold tracking-wider bg-trp border text-2xl font-whytemono">
                  projects
                </p>
              </div>
            </p>
          </div>
          <div className=" text-right py-10 px-30 mx-5  mb-7  w-96  flex justify-around rounded-3xl bg-cover bg-right-bottom bg-opacity-50 bg-gradient01 animate-movebg h-60">
