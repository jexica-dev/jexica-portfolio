...
export default function GlassButton() {
  ...
  return (
    <div className="w-screen relative ">
      <div className="z-10 text-2xl pt-20 bg-gradient-1 w-screen  flex  flex-col lg:flex-row md:flex-col sm:flex-col justify-center">
        <div className="">
          ...
          <div className=" text-right py-10 px-30 mx-5  mb-7  w-96  flex justify-around rounded-3xl bg-cover bg-right-bottom bg-opacity-50 bg-gradient01 h-60">
            <p className=" mix-blend-multiply pr-5 pb-5 text-8xl font-whyteinktrap leading-15">
              {" "}
              jexica ayran
            </p>
          </div>
        ...
        <div className="flex mx-5 p-10 top-0 left-0  relative w-96 h-128 border border-black rounded-3xl">
          <div className="text-3xl tracking-wide text-left font-whytemono pb-0 selection:bg-fuchsia-300 selection:text-fuchsia-900 mix-blend-burn">
